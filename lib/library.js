...
const vueDoxenPlugin = {
  install: (app) => {
    app.component('DoxenAccordion', DoxenAccordion);
    ...
    app.component('DoxenDeprecationBanner', DoxenDeprecationBanner);
    app.component('DoxenDeprecatedProp', DoxenDeprecatedProp);
