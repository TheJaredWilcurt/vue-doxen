...
export const styleTokensBootstrap5 = {
  ...
  // Deprecation Banner
  deprecationBanner: 'alert alert-dark',
  // Errors
  ...
  // Range Slider
  formFieldRangeSlider: 'form-range',
  formFieldRangeSliderContainer: 'rounded px-2 pt-1 bg-light',
  // Select
...
export const styleTokensVuetify3 = {
  ...
  deprecationBanner: 'v-banner v-theme--dark my-4',
  ...
  formFieldRadioDial: 'ma-2',
  formFieldRadioDialsContainer: 'v-radio-group',
