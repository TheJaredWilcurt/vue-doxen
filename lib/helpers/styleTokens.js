...
export const styleTokensBuiltIn = {
  ...
  codeBoxCopy: 'doxen-code-box-copy',
  codeBoxCopyButton: 'doxen-code-box-copy-button',
  codeBoxCopyVisible: 'doxen-code-box-copy-visible',
  codeBoxWrapper: 'doxen-code-box-wrapper',
...
export const styleTokensVuetify3 = {
  ...
  codeBoxCopyButton: 'v-btn v-btn--density-default v-btn--size-default v-btn--variant-flat mb-1',
