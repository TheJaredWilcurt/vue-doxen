export const codeThemesOptions = [
  ...
  {
    name: 'Solarized (Dark) (Detailed)',
    value: 'solarized_dark'
  },
  {
    name: 'Solarized (Light) (Detailed)',
