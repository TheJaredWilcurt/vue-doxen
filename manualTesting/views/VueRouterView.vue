<template>
  <div class="docs-page">
    ...
    <DocumentationSection id="demos" title="Make a reusable demos object">
      <p>
    ...
    <DocumentationSection id="adding-route" title="Adding a route for Vue-Doxen">
      <p>
    ...
    <DocumentationSection id="link-to-route" title="Linking to the Route">
      <p>
