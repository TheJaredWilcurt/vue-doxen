...
const ruleName = 'demos.allEmitsMustHave.description';
...
export const allEmitsMustHaveDescription = {
  rule: function (demos, options, linterSettings, errors) {
    allEmitsMustHave(demos, linterSettings, errors, 'description', 'a description', ruleName);
  },
  title: ruleName,
  description: 'Requires all emits have a description (<code>string</code>) on all demos and/or components (can be set to <code>undefined</code>).',
